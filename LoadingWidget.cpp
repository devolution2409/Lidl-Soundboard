...
LoadingWidget::LoadingWidget(QWidget *parent) : QWidget(parent)
{
    ...
    ui->image->setPixmap(QPixmap(":/icon/resources/forsenAim.png"));
    ui->image->setMaximumSize(24,24);
...
void LoadingWidget::setCurrent(int value)
{
    ...
    ui->label->setText(QString(tr("Opening file: %1, %2 %")).arg(_fileName).arg(ceil(percent))) ;
}
